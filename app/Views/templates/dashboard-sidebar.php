                ...
                <li class="nav-item">
                    ...
                    <div class="collapse <?= DisplayHelper::isPageInList($pageTitle, $lotPricingList, "show") ?>" id="lotPricingSubmenu">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="<?= BASE_URL ?>/custom-payment-plans-lot" class="nav-link d-flex align-items-center gap-2 <?= DisplayHelper::isActivePage($pageTitle, "Custom Payment Plans", "-fill text-bg-primary") ?>" <?= DisplayHelper::isActivePage($pageTitle, "Custom Payment Plans", "aria-current='page'") ?>><i class="bi bi-caret-right<?= DisplayHelper::isActivePage($pageTitle, "Custom Payment Plans", "-fill") ?>"></i> Custom Payment Plans</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
