    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                ...
                <?php $reservationsList = ["Burial Reservations", "Burial Reservation Requests", "Lot Reservations", "Reservation Requests", "Estate Reservations"]; ?>
                <li class="nav-item">
                    ...
                    <div class="collapse <?= DisplayHelper::isPageInList($pageTitle, $reservationsList, "show") ?>" id="reservationsSubmenu">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="<?= BASE_URL . "/lot-reservations" ?>" class="nav-link d-flex align-items-center gap-2 <?= DisplayHelper::isPageInList($pageTitle, ["Lot Reservations", "Reservation Requests"], "-fill text-bg-primary") ?>" <?= DisplayHelper::isPageInList($pageTitle, ["Lot Reservations", "Reservation Requests"], "aria-current='page'") ?>><i class="bi bi-caret-right<?= DisplayHelper::isPageInList($pageTitle, ["Lot Reservations", "Reservation Requests"], "-fill") ?>"></i> Lot Reservations</a></li>
                            <li><a href="<?= BASE_URL . "/estate-reservations" ?>" class="nav-link d-flex align-items-center gap-2 <?= DisplayHelper::isActivePage($pageTitle, "Estate Reservations", "-fill text-bg-primary") ?>" <?= DisplayHelper::isActivePage($pageTitle, "Estate Reservations", "aria-current='page'") ?>><i class="bi bi-caret-right<?= DisplayHelper::isActivePage($pageTitle, "Estate Reservations", "-fill") ?>"></i> Estate Reservations</a></li>
                        </ul>
                    </div>
                </li>
