...
<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <ul class="nav flex-column">
            ...
            <?php $lotPricingList = ["Phase Pricing List", "Estate Pricing"]; ?>
            <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2" data-bs-toggle="collapse" href="#lotPricingSubmenu" role="button" aria-expanded="<?= DisplayHelper::isPageInList($pageTitle, $lotPricingList, "true", "false") ?>" aria-controls="lotPricingSubmenu">
                <i class="bi bi-tag<?= DisplayHelper::isPageInList($pageTitle, $lotPricingList, "-fill") ?>"></i> Set Pricing <i class="bi bi-caret-down<?= DisplayHelper::isPageInList($pageTitle, $lotPricingList, "-fill") ?>"></i>
            </a>
