...
<div class="table-responsive-sm shadow">
    <table class="table table-striped table-hover table-bordered" id="table">
        ...
        <tbody>
            <?php 
                foreach ($burialReservationRequestsTable as $burialReservationRequestsRow) {
                    if (!empty($burialReservationRequestsTable)) {
                        $prefferedDate = Formatter::formatDateTime($burialReservationRequestsRow["date_time"]);

                        $location = $burialReservationRequestsRow["asset_id"];

                        $middleName = !empty($burialReservationRequestsRow["middle_name"]) ? " " . $burialReservationRequestsRow["middle_name"] . " " : " ";
                        $suffix = !empty($burialReservationRequestsRow["suffix"]) ? ", " . $burialReservationRequestsRow["suffix"] : "";
                        $interred = $burialReservationRequestsRow["first_name"] . $middleName . $burialReservationRequestsRow["last_name"] . $suffix;

                        $reservee = $burialReservationRequestsRow["reservee_id"];

                        $assetId = $burialReservationRequestsRow["asset_id"];
